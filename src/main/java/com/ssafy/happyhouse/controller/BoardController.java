...
//
//	@ApiOperation(value = "게시판 글 검색", notes = "검색한 게시글의 정보를 반환한다.", response = List.class)
//	@GetMapping("/{key}&{word}&{articleno}")
//	public ResponseEntity<List<BoardDto>> keywordArticle(
//			@ApiParam(value = "게시글을 얻기위한 부가정보.", required = true) @PathVariable("key") String key,
//			@PathVariable("word") String word, BoardParameterDto boardParameterDto) throws Exception {
//		logger.info("keywordArticle - 호출");
//		Map<String, String> param = new HashMap<String, String>();
//		param.put("key", key);
//		param.put("word", word);
//		return new ResponseEntity<List<BoardDto>>(boardService.keywordArticle(param), HttpStatus.OK);
//	}
